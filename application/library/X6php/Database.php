...
class X6php_Database {
    ...
    public static function fetch($resource_id, $type = MYSQL_ASSOC) {
        return self::$db->fetch_array($resource_id, $type);
    }
    ...
    public static function fetch_all($sql, $arg = array(), $key_field = '', $silent = false) {
    ...
    public static function result($resource_id, $row = 0) {
        return self::$db->result($resource_id, $row);
    }
    ...
    public static function num_rows($resource_id) {
        return self::$db->num_rows($resource_id);
    }
